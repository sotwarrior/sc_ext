...
namespace SitecoreExtensions {
    ...
    if (SitecoreExtensions.Context.IsValid()) {
        var optionsRepository = new Options.OptionsRepository((wrapper: Options.OptionsWrapper) => {
            ...
            var toolboxSearchBox = new Modules.ToolboxSearchBox.ToolboxSearchBoxModule('Toolbox Searchbox', '', wrapper.getModuleOptions('Toolbox Searchbox'));
            ...
            scExtManager.addModule(toolboxSearchBox);
